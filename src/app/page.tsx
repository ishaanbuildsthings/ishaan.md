...
import IshaanSection from "@/components/IshaanSection";

export default function Home() {
  return (
    <div className="min-h-screen lg:h-screen lg:overflow-hidden bg-background">
      <main className="h-full flex flex-col lg:flex-row gap-8 lg:gap-10 p-6 sm:p-8 lg:p-12 max-w-7xl mx-auto">
